...
public class TemplateRepository : ITemplateRepository {
    ...
    public TemplateRepository(DapperContext ctx) { _ctx = ctx; }
    ...
    public async Task<IEnumerable<Template>> GetAllAsync() {
        ...
        foreach (var t in templates) {
            ...
            foreach (var c in t.Controls)                 c.Bindings = bindings.Where(b => b.ControlId == c.Id).ToList();
        }
        return templates;
    }
    ...
    public async Task<Template?> GetAsync(Guid id) {
        ...
        foreach (var c in ctrls) c.Bindings = bindings.Where(b => b.ControlId == c.Id).ToList();
...
VALUES(@Id,@TemplateId,@ControlType,@Label,@DataPath,@Format,@OptionsJson);", new {
                c.Id, TemplateId = template.Id, c.ControlType, c.Label, c.DataPath, c.Format, c.OptionsJson
            }, tx);
...
VALUES(@Id,@ControlId,@ColumnHeader,@DataPath);", new {
                    b.Id, ControlId = c.Id, b.ColumnHeader, b.DataPath
                }, tx);
            }
        }
